          ...
          <div className="bg-white shadow sm:rounded-lg">
            <div className="px-4 py-5 sm:p-6">
              ...
              <p className="text-gray-700 mb-6">
                ...
                qualité sur l'actualité aéronautique, les technologies
                émergentes et les innovations dans le domaine de l'aviation.
              </p>
              ...
              <p className="text-gray-700 mb-6">
                ...
                analyses approfondies et des récits captivants. Nous croyons en
                la puissance de l'information pour inspirer et éduquer les
                passionnés d'aviation du monde entier.
              </p>
              ...
              <div className="mt-10 border-t border-gray-200 pt-6">
                ...
                <p className="text-gray-700 mb-6">
                  ...
                  secteur ou simplement curieux, nous vous invitons à nous
                  rejoindre et à participer à notre communauté en pleine
                  croissance.
                </p>
                <div className="mt-6">
                  <Link
      ...
      <footer className="bg-white border-t border-gray-200 mt-12">
        <div className="max-w-7xl mx-auto py-6 px-4 overflow-hidden sm:px-6 lg:px-8">
          <p className="text-center text-base text-gray-500">
            &copy; {new Date().getFullYear()} Doualair Blog. Tous droits
            réservés.
          </p>
        </div>
      </footer>
